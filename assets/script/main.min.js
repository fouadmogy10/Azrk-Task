const menuBtn = document.getElementById("menu-toggle"),
  ...
  menuList = document.getElementById("dynamic-menu"),
  menuData = [
  ...
  categoriesData = [
    ...
    { title: "الحلقان", count: 33, image: "assets/img/CatSlider-ec/F.jpg" },
    {
      title: "العقود",
      count: 33,
      image:
    ...
    { title: "الأطقم", count: 33, image: "assets/img/CatSlider-ec/M.jpg" },
  ],
  fullData = [...categoriesData, ...categoriesData],
  wrapper = document.getElementById("categories-wrapper");
fullData.forEach((e) => {
  let t = document.createElement("div");
  (t.className =
    "swiper-slide min-w-[276.77px]  min-h-[436.67px] md:min-h-[609px] rounded-[26px] overflow-hidden relative"),
    (t.innerHTML = `
  ...
  menuData.forEach((e) => {
    ...
    0 === e.children.length
      ? (t.innerHTML = `<a href="#" class="block hover:text-[#C98A40] border-b border-[#ffffff36] pb-1">${e.title}</a>`)
      : (t.innerHTML = `<button class="flex justify-between items-center w-full hover:text-[#C98A40] border-b border-[#ffffff36] pb-1"
               data-title="${e.title}">
         ${e.title}
         <img src="assets/Icons/down-arrow.svg">
       </button>`),
      menuList.appendChild(t);
  }),
  menuList.addEventListener("click", (e) => {
    let t = e.target.closest("[data-title]");
    if (!t) return;
    let s = menuData.find((e) => e.title === t.dataset.title);
    s &&
      ((subTitle.textContent = s.title),
      (subList.innerHTML = ""),
      s.children.forEach((e) => {
        let t = document.createElement("li");
        (t.innerHTML = `<a href="#" class="block hover:text-[#C98A40] border-b border-[#ffffff36] pb-1">${e}</a>`),
          subList.appendChild(t);
      }),
...
const openMenu = () => {
  ...
  closeMenu = () => {
    menu.classList.add("translate-x-full"), overlay.classList.add("hidden");
  },
  openMain = () => {
  ...
  closeAllFn = () => {
    closeMenu(), subMenu.classList.add("translate-x-full");
  };
...
const brands = [
  ...
  allBrands = [...brands, ...brands, ...brands],
  wrapperBrand = document.getElementById("brand-wrapper");
allBrands.forEach((e) => {
  ...
  (t.className =
    ...
    (t.innerHTML = `
      ...
      <div class="p-4 space-y-2 text-right">
        ...
        <p class="text-base text-[#252525B5] line-clamp-4">${e.description}</p>
        <a href="${e.link}" class="text-[#CE9461] underline text-xl">عرض المقالة</a>
      </div>
    `),
    ArticleWrapper.appendChild(t);
});
...
testimonials.forEach((e) => {
  ...
  (t.className = "swiper-slide"),
    ...
    `),
    testimonialsصrapper.appendChild(t);
});
const productsGrid = document.getElementById("productsGrid");
function toggleFAQ(e) {
  let t = e.closest(".faq-item"),
  ...
  if (
    (document.querySelectorAll(".faq-item").forEach((e) => {
      ...
      let s = e.querySelector(".faq-question");
      s.classList.remove("text-[#1E1E1E]"), s.classList.add("text-[#C98A40]");
      let a = e.querySelector(".faq-icon-box");
      a.classList.remove("bg-[#EAD3B9]"), a.classList.add("bg-[#CE9461]");
      let i = e.querySelector(".faq-icon");
      i.classList.remove("rotate-180");
    }),
    !s)
  ) {
    t.classList.add("active");
    let a = t.querySelector(".faq-answer");
    a.style.maxHeight = a.scrollHeight + "px";
    let i = t.querySelector(".faq-question");
    i.classList.remove("text-[#C98A40]"), i.classList.add("text-[#1E1E1E]");
    let l = t.querySelector(".faq-icon-box");
    l.classList.remove("bg-[#CE9461]"), l.classList.add("bg-[#EAD3B9]");
    let r = t.querySelector(".faq-icon");
...
products.forEach((e) => {
  let t = document.createElement("div");
  (t.className =
    "bg-[#F7F2E9] rounded-xl shadow-md overflow-hidden relative group  transition-all duration-300  min-h-[240px] min-w-[156px] md:min-w-[282px] md:min-h-[434.5px]"),
    (t.dataset.aos = "fade-up"),
    (t.dataset.aosDelay = e.delay),
    (t.innerHTML = `
